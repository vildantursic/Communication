...
app.controller('communicationCtrl', function ($scope, $mdDialog, $http, $mdToast, myHttp, myDialog, myPopup, $animate, $state, $timeout, $mdBottomSheet, $rootScope, $localStorage) {
